...
public:
  ...
  const std::vector<float>& getFjInputs_depth() { return fFjInputs_depth; }
  const std::vector<long long int>& getFjInputs_fibernum_S() { return fFjInputs_fibernum_S; }
  const std::vector<long long int>& getFjInputs_fibernum_Scorr() { return fFjInputs_fibernum_Scorr; }
  const std::vector<long long int>& getFjInputs_fibernum_C() { return fFjInputs_fibernum_C; }
...
private:
  ...
  float setDepth(const float tmax, const RecoInterface::RecoTowerData& recoTower, const DRsimInterface::DRsimSiPMData& sipm);
  ...
  std::vector<float> fFjInputs_depth;
  std::vector<long long int> fFjInputs_fibernum_S;
  std::vector<long long int> fFjInputs_fibernum_Scorr;
  std::vector<long long int> fFjInputs_fibernum_C;
